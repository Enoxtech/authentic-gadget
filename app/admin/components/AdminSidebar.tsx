...
import { Package, ShoppingCart, Users, BarChart3, Settings, LogOut, LayoutDashboard } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { id: "campaigns", label: "Campaigns", icon: BarChart3, href: "/admin/campaigns" },
  { id: "reviews", label: "Reviews", icon: BarChart3, href: "/admin/reviews" },
